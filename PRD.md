...
| ID | User Story | Priority | Acceptance Criteria |
|----|------------|----------|---------------------|
| FR-011 | As a user, I want to share my verdict as a visually branded card on social media so that my followers can see and try Nopamine. | High | Share button generates an image card (PNG or OG-tagged URL) containing: product name, verdict (Buy/Skip), a 1-line summary of reasoning, and Nopamine branding with URL. Supports sharing to Twitter/X, Instagram Stories, iMessage, and clipboard. |
...
| FR-013 | As a user, I want to copy a direct link to my verdict result so that I can paste it in chats, forums, or messages. | Medium | Copy link button provides a unique permalink to the verdict. Link resolves to a branded landing page showing the verdict with Nopamine CTA. |
